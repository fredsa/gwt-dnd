...
public class WidgetArea extends AbstractArea {
   ...
   * <ul>
   * <li><code>parent.add(widget, area.getLeft(), area.getTop())</code> leaves
   * the object in the exact same location on the screen</li>
   * <li>
   ...
   *          <code>null</code>, then <code>RootPanel().get()</code> is assumed
   */
  //  public WidgetArea(Widget widget, Widget reference) {
  //    setLeft(widget.getAbsoluteLeft());
  //    setTop(widget.getAbsoluteTop());
