...
public class MyApplication1 implements EntryPoint {
  ...
  public void onModuleLoad() {
    ...
    // setup dragging
    PickupDragController dragController = new PickupDragController(fp1, true);
    ...
    PickupDragController dragController2 = new PickupDragController(fp4, true);
